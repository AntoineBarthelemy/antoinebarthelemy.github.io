...
const DATA = {
  ...
  stats: [
    { value: 7,  plus: true,  label: { fr: "Projets réalisés", en: "Projects built" } },
  ...
  stages: [
    ...
    },
    {
      ...
      report: "assets/documents/report-malblanc.pdf",
  ...
  certifications: [
    ...
    { name: { fr: "Bootcamp Développement Web", en: "Web Development Bootcamp" }, org: "Le Wagon", year: { fr: "2024", en: "2024" } },
